...
To quickly illustrate these models in the exam, use this simple schematic representation:

```mermaid
graph TD
    subgraph Out of Africa Model
        A1[African Archaics] --> B1[African H. sapiens]
        B1 --> C1[Migrate to Europe/Asia]
        C1 -->|Replace| D1[Extinct Archaics]
    end
    
    subgraph Multiregional Model
        A2[African H. erectus] --> B2[African H. sapiens]
        C2[Asian H. erectus] --> D2[Asian H. sapiens]
        E2[European H. erectus] --> F2[European H. sapiens]
        B2 -.->|Gene Flow| D2
        D2 -.->|Gene Flow| F2
        F2 -.->|Gene Flow| B2
    end
...
### X. UPSC PREVIOUS YEAR QUESTIONS (PYQs) & ANSWER BLUEPRINTS

---

#### PYQ 1: "Europeans are closer to Neanderthals". Critically discuss in view of the African origin of human kind. [2019, 15 Marks]

* **Introduction (Approx. 40 words):** The statement refers to the discovery that non-African populations (including Europeans) possess 1-4% Neanderthal DNA. However, this does not contradict the **Recent African Origin (Out of Africa)** theory; rather, it refines it into the **Assimilation Model**.
* **Body Skeleton:**
  * *The African Origin Foundation:* Explain that all modern *Homo sapiens* evolved in Africa (~200,000 years ago). The vast majority of our genome is shared and originates from this African population.
  * *The Introgression Event:* When a subset of modern humans migrated out of Africa into Eurasia (~60,000 years ago), they encountered and interbred with indigenous Neanderthals.
  * *Explaining the "Closeness":* Because this interbreeding occurred *after* the Out-of-Africa migration, the Neanderthal genetic signature is only found in the descendants of the migrants (Europeans, Asians), not in the populations that remained in sub-Saharan Africa.
  * *Evolutionary Impact:* Mention adaptive introgression (e.g., Neanderthal genes boosting immune responses and skin adaptations to colder climates).
* **Conclusion (Approx. 40 words):** Therefore, Europeans are not evolutionary "closer" to Neanderthals in a fundamental sense; they are fully modern humans who merely carry a small genetic footprint of past admixture. The foundation of all humanity remains unequivocally African.
