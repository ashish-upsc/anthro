...
#### PYQ 1: Explain the impact of the concept of nature-man-spirit complex on sustainable use of natural resources with suitable examples. [2021, 20 Marks]
* **Introduction:** Formulated by L.P. Vidyarthi based on his study of the Maler tribe (1963), the Nature-Man-Spirit (N-M-S) complex is an ecological framework proving that tribal livelihood, social organization, and religious beliefs are an inseparable triad. 
* **Body (Sustainable Use of Resources):**
  * *Nature & Spirit (Sacred Groves):* Tribes do not view nature merely as a commodity, but as the abode of spirits (Gossayins). This religious sanction acts as a powerful conservation mechanism. Example: The *Sarnas* (Sacred Groves) of the Santhals and Mundas are pristine forest patches protected from logging due to spiritual reverence.
  * *Man & Nature (Restricted Exploitation):* Economic activities are restricted by ritual calendars, preventing over-exploitation. Example: The Maler practice *Khallu* (shifting cultivation) but observe strict taboos during the agricultural cycle, ensuring fallow periods for forest regeneration.
  * *Spirit & Man (Communal Solidarity):* Rituals tied to nature foster community cohesion, ensuring resources are shared equitably and not hoarded.
* **Conclusion:** The N-M-S complex demonstrates that traditional ecological knowledge (TEK) is built into the religious and social fabric of tribal life. Modern conservation efforts will fail unless they integrate the "Spirit" and "Man" dimensions of the tribes living in those ecosystems.

#### PYQ 2: Critically examine the contributions of Makhan Jha and B. N. Saraswati to the study of sacred complexes in India. [2018, 20 Marks]
* **Introduction:** L.P. Vidyarthi pioneered the 'Sacred Complex' framework with his study of Gaya (1961). His students and contemporaries, Makhan Jha and B.N. Saraswati, significantly expanded this concept across different geographies and religions.
* **Body:**
  * **Makhan Jha's Contributions:**
    * *Transnational Sacred Geography:* Jha applied the framework to **Janakpur in Nepal**. He proved that the "Kshetra" (sacred zone) of a civilization transcends modern political and national boundaries. Janakpur acts as a sacred center for Hindus in India as well.
    * *Islamic Sacred Complex:* Jha was a pioneer in applying the framework outside Hinduism. He studied the **Ratanpur Sacred Complex** (a Muslim pilgrimage site), proving the framework's universality in analyzing how shrines integrate diverse populations.
  * **B.N. Saraswati's Contributions:**
    * *Pluralistic Specialists:* In his study of **Kashi (Varanasi)**, Saraswati critiqued the assumption that Sacred Specialists were exclusively Brahmins. He highlighted the vital ritual roles of non-Brahminic and even untouchable castes (e.g., the *Doms* who manage the cremation ghats), proving that the sacred complex is a highly integrated, multi-caste phenomenon.
    * *Typology of Traditions:* He classified sacred traditions into Textual (Shastric) and Oral (Laukik), showing how both continuously interact at pilgrimage sites.
* **Conclusion:** Jha and Saraswati successfully rescued the Sacred Complex framework from being a localized, Brahmin-centric model, proving its cross-cultural and transnational validity in understanding the civilizational unity of the Indian subcontinent.
